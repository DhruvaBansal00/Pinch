...
class SplitwiseAccount(EntityInterface):
    def __init__(self, account_name, account_type, access_token):
        super().__init__()
        # Harcoding for now
        self.sObj = Splitwise("5VroAWaqz7NV8TtdosKf3i7LgPwXzTvhnsiyQzwu","Y08bKUj2t8EhmkROq5Vs28wrTU1Ih6pELQxXKY4Z",api_key="PGTAd3NRPmXjiZcK8yBKOu6iIMGpwVDKVCpPaMo0")
    ...
    def get_transactions(self, time: datetime.datetime):
        ...
        for expense in self.sObj.getExpenses(updated_after=self.last_updated, limit=1000):
            ...
            transaction = Transaction("Splitwise", eu.net_balance, expense.getDescription(), ut, ct)
